  ...
  return (
    <div className="col-xs-12 col-sm-12  col-lg-8 details-pro">
      ...
      <div className="row">
        ...
        <div className="col-12 col-md-5 product-right">
          <div className="product-policises-wrapper">
            <h5 className="m-0 mb-3">Thiên Long Flexoffice.com:</h5>
            <ul className="product-policises list-unstyled flex-column d-flex align-items-start m-0">
              <li className="media">
                <div className="mr-3">
                  <img
                    className="img-fluid lazyload loaded"
                    src="https://theme.hstatic.net/1000230347/1000729967/14/policy_product_image_1.png?v=975"
                    alt=""
                  />
                </div>
                <div className="media-body">Giao hàng toàn quốc</div>
              </li>
              <li className="media">
                <div className="mr-3">
                  <img
                    className="img-fluid lazyload loaded"
                    src="https://theme.hstatic.net/1000230347/1000729967/14/policy_product_image_2.png?v=975"
                    alt=""
                  />
                </div>
                <div className="media-body">Sản phẩm chính hãng</div>
              </li>
              <li className="media">
                <div className="mr-3">
                  <img
                    className="img-fluid lazyload loaded"
                    src="https://theme.hstatic.net/1000230347/1000729967/14/policy_product_image_3.png?v=975"
                    alt=""
                  />
                </div>
                <div className="media-body">Tích điểm đổi quà</div>
              </li>
              <li className="media">
                <div className="mr-3">
                  <img
                    className="img-fluid lazyload loaded"
                    src="https://theme.hstatic.net/1000230347/1000729967/14/policy_product_image_4.png?v=975"
                    alt=""
                  />
                </div>
                <div className="media-body">Nhiều khuyến mãi, ưu đãi</div>
              </li>
            </ul>
          </div>
        </div>
