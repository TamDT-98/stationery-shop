...
import ModalCard from "../Header/HeaderCenter/LeftContent/Login/ModalCard";
import useModal from "../Header/HeaderCenter/LeftContent/Login/useModal";
					...
					<div className='product-info'>
						...
						<div className='product-action'>
							<div className='group_action'>
								...
								<ModalCard isShowing={isShowing} hide={toggle} />
							</div>
						</div>
					</div>
				</form>
