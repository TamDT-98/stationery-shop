      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-xs-12 col-sm-6 col-md-4 text-center">
            <div className="certify-bct">
              <h4>CHỨNG NHẬN</h4>
              <a href="http://online.gov.vn/Home/WebDetails/42055">
                <img
                  src="https://theme.hstatic.net/1000230347/1000729967/14/footer_bct.png?v=974"
          ...
          <div className="col-xs-12 col-sm-6 col-md-4">
            <div className="payment-method">
              ...
              <a href="#">
                <img
                  src="https://theme.hstatic.net/1000230347/1000729967/14/footer_payment.png?v=974"
