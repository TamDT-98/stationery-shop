        ...
        <div className="col-12 col-md-7">
          ...
          <div className="form_button_details margin-top-15 w-100">
            <div className="form_product_content type1">
              <div className="soluong soluong_type_1 hidden">
                  <label>Số lượng:</label>
                  <div className="custom input_number_product custom-btn-number">
                      <button className="btn btn_num num_1 button button_qty">-</button>
                      <input className='form-control prd_quantity' value='5'/>
                      <button className="btn btn_num num_2 button button_qty">+</button>
                  </div>
              </div>
              <div className="warning-quantity">
				Sản phẩm này chỉ cho phép mua tối thiểu <b>5 sản phẩm</b></div>
                <div className="button_actions clearfix">
                    <button type='submit' className="btn btn_base btn_add_cart btn-cart add_to_cart disabled"><span className-'text_1'>Chọn Mua</span></button>
                </div>
            </div>
          </div>
        </div>
