    ...
    <section className="section sec_tab">
      <div className="container card py-2">
        ...
        <div className="rte product_getcontent py-3 pos-relative">
          <div id="content" className={Collapse ? "collapse" : "not-collapse"}>
            <p>
          ...
          <div
            className={
              Collapse
                ? "ega-pro__seemore text-center pos-relative show"
                : "ega-pro__seemore text-center pos-relative show hidden"
            }
          >
            <a
