              ...
              <ul>
                <li className="filter-item filter-item--check-box filter-item--green">
                  <span>
                    ...
                    >
                      <input type="checkbox" id="filter-duoi-100-000d" onchange="" data-group="Khoảng giá" data-field="price" data-text="Dưới 100.000đ" value="(price:product <100000)" data-operator="||" checked="checked" />
                      <i class="fa hidden"></i>
